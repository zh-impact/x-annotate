...
describe("replaceItemAtIndex", () => {
  it("replaces an item at a specific index in an array", () => {
    ...
    expect(replaceItemAtIndex(arr, index, newValue)).toEqual([
      1,
      2,
      "new value",
      4,
  ...
  it("works with out-of-bounds indices", () => {
    const arr = [1, 2, 3, 4];
    const index = 5;
    const newValue = "new value";
